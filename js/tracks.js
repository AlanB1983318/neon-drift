...
export const TRACKS = [
  ...
  makeTrack({
    name: 'Crossover',
    description: 'Figure-eight with extra esses and bridge crossings.',
    roadWidth: 56,
    roadType: 'DIRT',
    surfaces: [
      { type: 'GRASS', x: 0, y: 0, w: 960, h: 640 },
      { type: 'ASPHALT', x: 390, y: 85, w: 180, h: 55 },
      { type: 'ASPHALT', x: 390, y: 465, w: 180, h: 55 },
      { type: 'MUD', x: 160, y: 360, w: 80, h: 70 },
      { type: 'MUD', x: 720, y: 200, w: 80, h: 70 },
    ],
    walls: [
      ...
      { x: 140, y: 250, w: 22, h: 60 },
      { x: 780, y: 330, w: 22, h: 60 },
    ],
    checkpointIndices: [0, 4, 8, 12, 16, 20],
    checkpointRadii: [50, 50, 50, 50, 50, 50],
    waypoints: [
      { x: 240, y: 510 }, { x: 210, y: 450 }, { x: 215, y: 380 }, { x: 245, y: 310 },
      { x: 290, y: 250 }, { x: 360, y: 200 }, { x: 440, y: 170 }, { x: 520, y: 160 },
      { x: 600, y: 175 }, { x: 670, y: 210 }, { x: 730, y: 270 }, { x: 760, y: 340 },
      { x: 755, y: 410 }, { x: 720, y: 470 }, { x: 660, y: 510 }, { x: 580, y: 525 },
      { x: 500, y: 515 }, { x: 480, y: 470 }, { x: 500, y: 410 }, { x: 480, y: 350 },
      { x: 450, y: 410 }, { x: 420, y: 470 }, { x: 360, y: 510 }, { x: 290, y: 520 },
      { x: 240, y: 510 },
    ],
    starts: [
      { x: 210, y: 490, angle: -Math.PI / 2 },
      { x: 235, y: 500, angle: -Math.PI / 2 },
      { x: 260, y: 508, angle: -Math.PI / 2 },
      { x: 285, y: 500, angle: -Math.PI / 2 },
    ],
    decorations: [
  ...
  makeTrack({
    name: 'Canyon Run',
    description: 'Long straights, hairpins, and a nasty chicane.',
    roadWidth: 54,
    surfaces: [
      { type: 'GRASS', x: 0, y: 0, w: 960, h: 640 },
      { type: 'ASPHALT', x: 100, y: 280, w: 320, h: 70 },
      { type: 'ASPHALT', x: 540, y: 280, w: 280, h: 70 },
      { type: 'MUD', x: 480, y: 200, w: 90, h: 180 },
      { type: 'MUD', x: 660, y: 200, w: 90, h: 180 },
    ],
    walls: [
      ...
      { x: 380, y: 195, w: 22, h: 55 },
      { x: 560, y: 370, w: 22, h: 55 },
    ],
    checkpointIndices: [0, 5, 10, 15, 20, 24],
    waypoints: [
      { x: 140, y: 320 }, { x: 220, y: 315 }, { x: 310, y: 310 }, { x: 400, y: 312 },
      { x: 490, y: 305 }, { x: 580, y: 308 }, { x: 670, y: 312 }, { x: 760, y: 308 },
      { x: 830, y: 295 }, { x: 850, y: 260 }, { x: 800, y: 230 }, { x: 700, y: 215 },
      { x: 590, y: 210 }, { x: 480, y: 215 }, { x: 380, y: 225 }, { x: 300, y: 245 },
      { x: 250, y: 275 }, { x: 230, y: 310 }, { x: 250, y: 345 }, { x: 300, y: 365 },
      { x: 380, y: 370 }, { x: 470, y: 360 }, { x: 560, y: 345 }, { x: 640, y: 335 },
      { x: 720, y: 340 }, { x: 780, y: 355 }, { x: 820, y: 340 }, { x: 780, y: 315 },
      { x: 680, y: 310 }, { x: 560, y: 315 }, { x: 420, y: 318 }, { x: 280, y: 320 },
      { x: 140, y: 320 },
    ],
    starts: [
      { x: 120, y: 345, angle: 0 },
