import { SURFACE, dist, clamp } from './utils.js?v=26';
import { boxesFromWaypoints, coinsFromWaypoints } from './items.js?v=26';
...
export const TRACKS = [
  ...
  makeTrack({
    ...
    waypoints: [
      ...
      { x: 650, y: 280 }, { x: 500, y: 220 }, { x: 350, y: 280 },
      { x: 220, y: 320 }, { x: 140, y: 320 },
    ],
    starts: [
      { x: 120, y: 350, angle: 0 },
      { x: 120, y: 330, angle: 0 },
